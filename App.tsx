...
const HOTMART_URL = 'https://pay.hotmart.com/R106438511S?off=nxhm34n5';
...
const DASHBOARD_WEBHOOK_COMBO = 'https://mighty-dont-supplemental-perfume.trycloudflare.com/api/inscricao-combo-alunas';
...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 border border-[#22C55E]/30 rounded-full mb-4">
      <Sparkles size={14} className="text-[#22C55E]" />
      <span className="text-xs md:text-sm font-bold text-[#16A34A] uppercase tracking-wider">{children}</span>
    </div>
  );
}
...
function Dobra1Promessa() {
  return (
    <section className="relative py-12 md:py-20 px-4 bg-gradient-to-b from-[#1F1B16] to-[#2C2620] text-white overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-[#22C55E] opacity-10 rounded-full blur-3xl" />
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left">
            ...
            <div className="bg-[#22C55E]/15 border border-[#22C55E]/40 rounded-2xl p-4 mb-6">
              <p className="text-sm md:text-base text-white">
                Pra novos alunos: <span className="line-through text-[#D4C4A8]">R$ 697</span> &nbsp;→&nbsp; <span className="font-bold text-[#22C55E]">Pra você (aluna): R$ 397</span>
              </p>
            </div>
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-base md:text-lg text-[#5C4033] max-w-2xl mx-auto">
            Pagando avulso, cada um custa <span className="font-bold text-[#A8261E]">R$ 297 por ano</span>. Multiplicado pelos 7, dá <span className="font-bold text-[#A8261E]">R$ 2.079 todo ano</span>. Hoje, porque você já é nossa aluna, leva os 7 vitalícios por apenas <span className="font-bold text-[#22C55E]">R$ 397</span>.
          </p>
        ...
        <div className="mt-10 bg-gradient-to-br from-[#1F1B16] to-[#2C2620] text-white rounded-3xl p-8 md:p-10 shadow-2xl border-2 border-[#22C55E]/40">
          <div className="text-center space-y-3">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#22C55E] to-[#16A34A] rounded-full mb-2">
              <Heart size={14} className="text-white fill-white" />
              <span className="text-xs md:text-sm font-bold text-white uppercase tracking-wider">🎁 EXCLUSIVO PARA ALUNAS</span>
            </div>

            <p className="text-[#D4C4A8] text-sm md:text-base uppercase tracking-wider mt-4">Se você fosse pagar avulso</p>
            <div className="grid md:grid-cols-3 gap-3 max-w-3xl mx-auto py-4">
              <div className="bg-[#3D3D3D]/40 rounded-2xl p-4">
                <p className="text-[#D4C4A8] text-xs uppercase mb-1">Por ano</p>
                <p className="text-xl md:text-2xl font-bold text-[#A8261E]">R$ 2.079</p>
                <p className="text-xs text-[#D4C4A8]">(7 × R$ 297)</p>
              </div>
              <div className="bg-[#3D3D3D]/40 rounded-2xl p-4">
                <p className="text-[#D4C4A8] text-xs uppercase mb-1">Em 5 anos</p>
                <p className="text-xl md:text-2xl font-bold text-[#A8261E]">R$ 10.395</p>
                <p className="text-xs text-[#D4C4A8]">(R$ 2.079 × 5)</p>
              </div>
              <div className="bg-[#3D3D3D]/40 rounded-2xl p-4">
                <p className="text-[#D4C4A8] text-xs uppercase mb-1">Pra novos alunos</p>
                <p className="text-xl md:text-2xl font-bold text-[#D4C4A8] line-through">R$ 697</p>
                <p className="text-xs text-[#D4C4A8]">(vitalício)</p>
              </div>
            </div>
            ...
            <div className="mt-5 bg-[#22C55E]/15 border border-[#22C55E]/40 rounded-2xl p-4 max-w-xl mx-auto">
              <p className="text-xs uppercase text-[#22C55E] font-bold mb-1">Economia REAL pra você</p>
              <p className="text-sm md:text-base text-white">Em vez de R$ 697 que outras pagariam → você paga <span className="font-bold text-[#22C55E]">R$ 397</span></p>
              <p className="text-sm md:text-base text-white mt-1">Em vez de R$ 10.395 que pagaria avulso em 5 anos → você economiza <span className="font-bold text-[#22C55E]">R$ 9.998 (96% off)</span></p>
            </div>
    ...
    <section className="py-16 md:py-20 px-4 bg-gradient-to-b from-[#1F1B16] to-[#2C2620] text-white">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-gradient-to-br from-[#22C55E]/20 to-[#16A34A]/10 border-2 border-[#22C55E] rounded-2xl p-6 md:p-8 text-center">
          ...
          <p className="text-6xl md:text-8xl font-bold text-[#22C55E] mb-4">R$ 397</p>
...
function Dobra9PrecoBotao() {
  return (
    <section className="py-16 md:py-24 px-4 bg-gradient-to-br from-[#16A34A] to-[#22C55E] text-white">
      <div className="container mx-auto max-w-3xl text-center">
        ...
        <div className="bg-white text-[#3D3D3D] rounded-3xl p-8 md:p-12 shadow-2xl">
          <p className="text-base md:text-lg text-[#5C4033] uppercase tracking-wider mb-1">Pra novos alunos</p>
          <p className="text-2xl md:text-3xl line-through text-[#5C4033]/60 mb-1">R$ 697</p>
          <p className="text-sm text-[#5C4033] mb-4">(equivalente a pagar avulso R$ 10.395 em 5 anos)</p>

          <div className="my-5 border-t border-[#E8DFD0]" />
          ...
          <ul className="text-left max-w-md mx-auto space-y-3 mb-8">
            {[
              ...
              '7 IAs de bônus exclusivas do combo',
    ...
    <section className="py-16 md:py-20 px-4 bg-gradient-to-b from-[#FDF9F3] to-[#F5EFE6]">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-5 text-lg leading-relaxed text-[#3D3D3D]">
          ...
          <p>Daqui <span className="font-bold">1 ano</span>, quando você ver outra artesã do seu bairro vendendo R$ 50 mil/mês, vai voltar aqui. Mas o preço de R$ 397 não vai mais existir.</p>
        </div>
        <div className="mt-10 bg-gradient-to-br from-[#1F1B16] to-[#2C2620] text-white rounded-2xl p-6 md:p-8">
          <div className="grid md:grid-cols-3 gap-4 text-center">
            <div>
              <p className="text-[#22C55E] font-bold text-2xl md:text-3xl">R$ 397</p>
    ...
    <section className="py-20 md:py-32 px-4 bg-gradient-to-br from-[#1F1B16] via-[#2C2620] to-[#3D3D3D] text-white relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-3xl relative z-10 text-center">
        ...
        <div className="bg-[#3D3D3D]/50 backdrop-blur rounded-2xl p-6 md:p-8 mb-8">
          <p className="text-[#D4C4A8] mb-2">Avulso renovando 5 anos: <span className="text-[#A8261E] font-bold">R$ 10.395</span></p>
        ...
        <p className="text-sm text-[#D4C4A8] mt-8 italic max-w-xl mx-auto">
          Oferta exclusiva pra alunas. Acesso liberado pela página de aluna oficial. Depois dessa janela, o combo só está disponível por R$ 697.
        </p>
      </div>
    </section>
  );
